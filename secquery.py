...
class SecQuery:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&SecQuery')
        self.toolbar = self.iface.addToolBar(u'SecQuery')
        self.toolbar.setObjectName(u'SecQuery')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SecQuery', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/secquery/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Query point data from sectors'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = SecQueryDockWidget()
